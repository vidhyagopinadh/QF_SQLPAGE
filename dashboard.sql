...
-- Dashboard Content with Button and Loader Modal
SELECT 'html' AS component, '
<style>
  :root {
    --primary: #2563eb;
...
<div class="qfg-wrap">
  ...
  <button class="view_dash_btn" id="sqlpageDashboardBtn">
    <i class="fas fa-chart-line"></i>
    View Surveilr Dashboard (Port 9227)
  </button>

  <p style="margin-top: 16px; color: #64748b; font-size: 0.85rem;">
    This will connect to your running Surveilr instance. Make sure the following commands are running:
  </p>
